...
class TestLaskerMorris(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertEqual(len(self.game.invalid_fields), 22)
        self.assertEqual(self.game.current_player.color, "blue")

    @patch('subprocess.Popen')
    def test_make_move_from_hand(self, mock_popen):
    ...
    def test_invalid_target_position(self):
    ...
    def test_moving_piece_on_board(self):
    ...
    def test_mill_formation_and_capture(self):
    ...
    def test_invalid_capture_without_mill(self):
    ...
    def test_adjacent_move_requirement(self):
    ...
    def test_win_condition(self):
        """Test win condition when player has fewer than 3 pieces"""
        # Setup: Leave blue with only 2 pieces
        ...
        self.assertEqual(winner, self.game._player2)  # Orange should win
    ...
    def test_occupied_target_position(self):
    ...
    @patch('click.echo')
    @patch('subprocess.Popen')
    def test_visual_display(self, mock_popen, mock_echo):
    ...
    def test_run_game_invalid_move(self, mock_sleep):
